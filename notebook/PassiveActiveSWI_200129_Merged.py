...
#%%
#def update_run(varlist,it,silent=False,start_basecase=True,f_basecase=None):
#    if start_basecase:
#        strt,sconc = get_base_hds_conc()
#    
#    ssm_data = {}
#    #Make timestamp
#    sep = ''
...
#     print('Running Multiprocessing MC:...')
#     # it_select = range(tot_it)
#     # it_select = (1,)
#     runyn=True
#     pooling=True
#     start_basecase=True
...
#     results = [pool.apply(update_run_model,args=(varlist,it),kwds={'pooling':pooling,
#                                                                         'runyn':runyn,
#                                                                         'start_basecase':start_basecase,
#                                                                         'silent':silent}) for it in range(tot_it)]
